...
class Purchase(BaseModel):
    ...
    distributor_id = db.Column(db.String(36), db.ForeignKey('distributors.id'), nullable=True)
...
class ApprovalRequest(BaseModel):
    ...
    id = db.Column(db.String(36), primary_key=True, default=str(uuid4()))
    agent_id = db.Column(db.String(36), db.ForeignKey('agents.id'), nullable=False)
    distributor_id = db.Column(db.String(36), db.ForeignKey('distributors.id'), nullable=False)
